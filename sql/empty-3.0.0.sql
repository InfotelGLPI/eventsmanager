...
CREATE TABLE `glpi_plugin_eventsmanager_events` (
   ...
   `users_assigned` int(11) NOT NULL default '0' COMMENT 'RELATION to glpi_users (id)',
   `groups_assigned` int(11) NOT NULL default '0' COMMENT 'RELATION to glpi_groups (id)',
   `users_close` int(11) NOT NULL default '0' COMMENT 'RELATION to glpi_users (id)',
