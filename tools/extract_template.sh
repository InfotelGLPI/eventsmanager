...
xgettext *.php */*.php --copyright-holder='Eventsmanager Development Team' --package-name='GLPI - Eventsmanager plugin' --package-version='1.0.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
