...
class PluginEventsmanagerOrigin extends CommonDropdown {
   ...
   function dropdownItemOrigin($ID, $value = 0) {
      ...
      if ($ID > 0) {
         ...
         $params = ['itemtype' => '__VALUE__',
                    'id'       => $ID];
         Ajax::updateItemOnSelectEvent("dropdown_itemtype$rand", "span_itemtype",
   ...
   static function selectItems(CommonDBTM $origin) {
      ...
      self::dropdownItems($origin->fields['itemtype'],
