...
if (isset($_POST["add"])) {
    ...
    // Authorization: attaching an equipment mutates the parent event and fires a
    // notification. Replay the plugin-right guard on the parent event, exactly as
    // the delete branch below and ajax/itemevent.php do - Event_Item carries no
    // $rightname of its own.
    $event = new Event();
